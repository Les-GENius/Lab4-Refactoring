...
public class OrdersWriterTest {
    ...
    @Test
    public void NoOrder() {
        assertEquals("{\"orders\": []}", new OrdersWriter(new Orders()).orders.toString());
    }

    @Test
    public void OneOrder() {
        String order111 = "{\"id\": 111, \"products\": []}";
        assertEquals("{\"orders\": [" + order111 + "]}", new OrdersWriter(orders).orders.toString());
    }
    ...
    public void TwoOrders() {
        ...
        assertEquals("{\"orders\": [" + order111Json + ", " + order222Json + "]}", new OrdersWriter(orders).orders.toString());
    }
    ...
    public void OneOrderWithOneProduct() {
        ...
        assertEquals("{\"orders\": [" + order111Json + "]}", new OrdersWriter(orders).orders.toString());
    }
